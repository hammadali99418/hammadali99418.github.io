...
window.addEventListener("load", () => {
    document.querySelectorAll(".skill .outer-circle svg circle").forEach(circle => {
        const skill = circle.closest(".skill");
        const percentText = skill.querySelector(".counter span").textContent.trim();
    ...
    const aboutContents = document.querySelectorAll(".content-about > .content");
    aboutButtons.forEach((button, index) => {
        button.addEventListener("click", () => {
            aboutButtons.forEach(btn => btn.classList.remove("active"));
            button.classList.add("active");
            aboutContents.forEach((content, contentIndex) => {
